    ...
    try {
      if (
        ...
        await resend.emails.send({
          ...
          html: `
            <div style="font-family: 'Inter', 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(145deg, #ffffff, #fdfbfb); padding: 48px; border-radius: 24px; box-shadow: 0 20px 40px rgba(0,0,0,0.05); border: 1px solid rgba(240, 108, 40, 0.1);">
              ...
              <div style="background: #ffffff; border-radius: 16px; padding: 40px; text-align: center; box-shadow: 0 10px 25px rgba(0,0,0,0.03); border: 1px solid #f1f5f9;">
                ...
                <div style="background: linear-gradient(135deg, #fff7ed 0%, #ffedd5 100%); border: 2px dashed rgba(240, 108, 40, 0.3); border-radius: 12px; padding: 24px; display: inline-block; margin-bottom: 32px; box-shadow: inset 0 2px 4px rgba(240,108,40,0.05);">
