...
<head>
  ...
  <style>
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .otp-box { background-color: #374151; }
      .otp-code { color: #f9fafb; }
      .footer { background-color: #1f2937; border-color: #374151; }
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Use the verification code below to securely access your Promotr Admin account.</p>
      <div class="otp-box">
        <p class="otp-code">${otp}</p>
      </div>
      <p style="font-size: 14px; color: #ef4444; font-weight: 600;">Code expires in 5 minutes</p>
    </div>
    <div class="footer">
      <p>If you didn't request this code, please securely ignore this email.</p>
    </div>
  </div>
</body>
</html>
